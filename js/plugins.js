...
window.scrollReveal = (function (window) {
  ...
  // if true, scrollReveal.init() is automatically called upon instantiation
      init: true
    },
  ...
  //  After all values are parsed, make sure our our
...
var makeItRain = function() {
	...
	while (increment < 100) {
	  ...
	  var randoHundo = (Math.floor(Math.random() * (97 - 1 + 1) + 1));
	  ...
	  midDrops += '<div class="drop" style="right: ' + increment + '%; animation-delay: 0.' + randoHundo + 's; animation-duration: 0.5' + randoHundo + 's;"><div class="stem" style="animation-delay: 0.' + randoHundo + 's; animation-duration: 0.5' + randoHundo + 's;"></div><div class="splat" style="animation-delay: 0.' + randoHundo + 's; animation-duration: 0.5' + randoHundo + 's;"></div></div>';
...
(function () {
	'use strict';
	 ...
	 window.onload = function() {
		...
		//WRENCH-BOX RESIZE FUNCTION
		//Check wrench-box height on load
		var wrenchHeight = document.getElementById("wrench-painted").height + "px";
		$("#wrench-box").height(wrenchHeight);
...
var Modal = (function() {
  ...
  var w = window;
  var isOpen = false;
  var contentDelay = 300; // duration after you click the button and wait for the content to show
  var len = trigger.length;
  var scrollGif = $('.mod-scroll'); // the scroll wheel gif on modals
  ...
  var open = function(m, div) {
    ...
    if (!isOpen) {
	  ...
	  if (!scrollGif.hasClass('hide-scroll')){
			scrollGif.addClass('hide-scroll');
	    } //in case the user didn't wait to close
    }
  ...
  var close = function(event) {
	...
	if (isOpen && target.classList.contains('modal__bg') || target.classList.contains('modal__close')) {
		...
		function showScrollGif(){
			if (!scrollGif.hasClass('hide-scroll')){
				scrollGif.addClass('hide-scroll');
			} //in case the user didn't wait 3 seconds, add the class
			
				scrollGif.removeClass('hide-scroll');
				 //wait until the modal is closed and remove the hiding class
		}
		setTimeout(showScrollGif, 200);
...
//HOMEMADE
// Change wrench-box height based off size of wrench-painted
//console.log("wrench-painted height: " + wrenchHeight)
...
//HOMEMADE
//Handling clicks on buttons with animations
$('#ab-1').click(function() {
	window.open("https://consume.world");
});
$('#ab-2').click(function() {
	window.open("https://wsatchmo.github.io/");
});
$('#ab-3').click(function() {
	window.open("https://www.aloesinwonderland.com/virtual-tour");
});
$('#gb-1').click(function() {
	window.open("../pages/Crystal_Collector_Game/index.html");
});
$('#gb-2').click(function() {
	window.open("https://wsatchmo.github.io/React_Clicky/");
});
$('#gb-3').click(function() {
	window.open("https://wsatchmo.github.io/React_Clicky_RNG/");
});
$('#gb-4').click(function() {
	window.open("../pages/Fallout_Guess_Game/index.html");
});
$('#gb-5').click(function() {
	window.open("https://wsatchmo.github.io/Vue_ScienceTest/");
});
$('#book-1-site').click(function() {
	window.open("https://consume.world");
});
$('#book-1').click(function() {
	window.open("../documents/Not Without a Bang_Preview.pdf");
});
$('#book-2').click(function() {
	window.open("../documents/KONSTANTIN_3030.pdf");
});
