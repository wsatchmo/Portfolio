...
var wordArr = ["robot", "laser", "mentat", "nuka", "fatman", "grenade", "radiation", "raider", 
"psycho", "vault", "baseball", "alien", "wanderer", "father", "guns", "brotherhood", "pipboy",
"handy", "drink", "mutant", "atoms", "china", "america", "water", "melee", "russia", "caesar", 
"railroad", "brotherhood", "pugilist", "knife", "deathclaw", "survival", "enclave", "armor"];
...
function playGame(){
    ...
    document.onkeyup = function(event) {
        ...
        if (guesses === 0 || winsBool){ 
           document.getElementById('pressanykey').innerHTML = "Press any letter to play again."; 
        } else {
